...
import type { TAction, TActionButtonData } from '~/types/shared.types.ts';

export const ACTIONS_BUTTONS_DATA: Record<TAction, Omit<TActionButtonData, 'disabled' | 'handler'>> = {
  update: {
    action: 'update',
